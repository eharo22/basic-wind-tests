...
#include "WindTests.hh" // Changed from WindEffects.hh
...
class gz::sim::systems::WindTestsPrivate // Changed from WindEffectsPrivate
{
...
/////////////////////////////////////////////////
void WindTestsPrivate::Load(EntityComponentManager &_ecm, // Changed from WindEffectsPrivate
                              const std::shared_ptr<const sdf::Element> &_sdf)
{
...
//////////////////////////////////////////////////
void WindTestsPrivate::SetupTransport(const std::string &_worldName) // Changed from WindEffectsPrivate
{
  ...
  this->node.Subscribe("/world/" + validWorldName + "/wind",
                       &WindTestsPrivate::OnWindMsg, this); // Changed from WindEffectsPrivate

  // Wind info service
  this->node.Advertise("/world/" + validWorldName + "/wind_info",
                       &WindTestsPrivate::WindInfoService, this); // Changed from WindEffectsPrivate
}

//////////////////////////////////////////////////
void WindTestsPrivate::UpdateWindVelocity(const UpdateInfo &_info, // Changed from WindEffectsPrivate
                                            EntityComponentManager &_ecm)
{
  GZ_PROFILE("WindTestsPrivate::UpdateWindVelocity"); // Changed from WindEffectsPrivate
...
//////////////////////////////////////////////////
void WindTestsPrivate::ApplyWindForce(const UpdateInfo &, // Changed from WindEffectsPrivate
                                        EntityComponentManager &_ecm)
{
  GZ_PROFILE("WindTestsPrivate::ApplyWindForce"); // Changed from WindEffectsPrivate
  auto windVel =
      _ecm.Component<components::WorldLinearVelocity>(this->windEntity);
  if (!windVel)
    return;
...
//////////////////////////////////////////////////
void WindTestsPrivate::OnWindMsg(const msgs::Wind &_msg) // Changed from WindEffectsPrivate
{
...
//////////////////////////////////////////////////
void WindTestsPrivate::ProcessCommandQueue(EntityComponentManager &_ecm) // Changed from WindEffectsPrivate
{
...
//////////////////////////////////////////////////
bool WindTestsPrivate::WindInfoService(msgs::Wind &_msg) // Changed from WindEffectsPrivate
{
...
//////////////////////////////////////////////////
WindTests::WindTests() : System(), // Changed from WindEffects
    dataPtr(std::make_unique<WindTestsPrivate>()) // Changed from WindEffectsPrivate
{
}

//////////////////////////////////////////////////
WindTests::~WindTests() = default; // Changed from WindEffects

//////////////////////////////////////////////////
void WindTests::Configure(const Entity &_entity, // Changed from WindEffects
    const std::shared_ptr<const sdf::Element> &_sdf,
    EntityComponentManager &_ecm,
    EventManager &)
{
...
//////////////////////////////////////////////////
void WindTests::PreUpdate(const UpdateInfo &_info, // Changed from WindEffects
                            EntityComponentManager &_ecm)
{
  GZ_PROFILE("WindTests::PreUpdate"); // Changed from WindEffects::PreUpdate
...
GZ_ADD_PLUGIN(WindTests, System, // Changed from WindEffects
  WindTests::ISystemConfigure, // Changed from WindEffects
  WindTests::ISystemPreUpdate // Changed from WindEffects
)

GZ_ADD_PLUGIN_ALIAS(WindTests, "gz::sim::systems::WindTests") // Changed from WindEffects